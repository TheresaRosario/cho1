    ...
    <div class="content">
        ...
        <label for="edit_batchNumber"style="margin-right:10px">Batch/LotNumber:</label>
        ...
        <input type="text" id="edit_description" style="margin-right:5px"name="edit_description" value="<?php echo $supplyData['Description']; ?>">
        ...
        <input type="date" id="edit_manufacturingDate" name="edit_manufacturingDate" style="margin-right:0px"value="<?php echo $supplyData['Mfg_Date']; ?>">
        <label for="edit_expirationDate"style="margin-top:20px;margin-left:250px">Expiration Date:</label>
        ...
        <button type="submit" name="editSupply"style="margin-left:40%; padding:17px; width:200px;">EDIT SUPPLY</button>
    </form>
    <?php
    ...
    <script>
        ...
        // Call function to open the success modal when the page loads
