...
<body>
    ...
    <form method="post" action="permanent_archive_delete.php" style="margin-top:30px">
    ...
    <input type="submit" value="Restore " style="padding:5px; margin-left:95px; width: 10%; background-color: green; color: white">
    ...
    <div class="table-container">
        ...
        <thead>
            <tr>
                ...
                <th  style="color:white">Lot/Batch Number</th>
