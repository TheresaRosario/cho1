...
function releaseMedicine($medicine_name, $release_quantity, $description, $batch_number, $manufacturing_date, $expiration_date, $issued_to, $conn) {
    ...
    if ($result && $result->num_rows > 0) {
        ...
        if ($update_stmt->execute()) {
            ...
            $insert_stmt->bind_param("ssssissss", $medicine_name, $batch_number, $description, $release_quantity, $manufacturing_date, $expiration_date, $issued_to, $medicine_id);
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!isset($_POST['Item_Name'], $_POST['Lot_Number'], $_POST['Batch_Number'], $_POST['Description'], $_POST['QTY'], $_POST['Mfg_Date'], $_POST['Exp_Date'], $_POST['IssuedTo'])) {
        ...
        $result = releaseMedicine($medicine_name, $release_quantity, $description,$batch_number, $manufacturing_date, $expiration_date, $issued_to, $conn);
