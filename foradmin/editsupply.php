    ...
    <div class="content">
        ...
        <input type="date" id="edit_manufacturingDate" name="edit_manufacturingDate" style="margin-right:0px"value="<?php echo $supplyData['Manufacturing_Date']; ?>">
        <label for="edit_expirationDate"style="margin-top:20px;margin-left:50px">Expiration Date:</label>
