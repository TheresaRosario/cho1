...
function generateReportCSV($startDate, $endDate, $pdo) {
    ...
    $log_sql = "INSERT INTO logs (id, action, date_time) VALUES (NULL, 'admin report generation', NOW())";
    if ($pdo->query($log_sql) === FALSE) {
        return "Error inserting report generation log: " . $pdo->error;
    }
...
<body>
    <header style="font-size:15px;margin-right:%;">
...
<div class="table-container" style="margin-top: 20px;">
    <table >
        ...
        <tbody>
            ...
            <footer style="position: fixed; bottom: 20px; right: 100px; font-size: 12px; text-align: right;">
