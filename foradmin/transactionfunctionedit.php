...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['editSupply'])) {
    ...
    $update_query = "UPDATE medicines SET date='$date', item_name='$itemName', batch_number='$batchNumber', description='$description', qty='$qty', Mfg_date='$manufacturingDate', Exp_Date='$expirationDate' WHERE medicine_id='$id'";
